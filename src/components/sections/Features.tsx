...
export function Features() {
  ...
  return (
    <section id="features" className="py-24 bg-bg scroll-mt-16">
            ...
            {items.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="min-w-[260px] bg-bg-secondary rounded-2xl p-6 border border-bg-surface hover:border-primary transition-colors shrink-0"
                >
